...
if (window.attachEvent) {
	window.attachEvent('onload', function() {
		var el = document.createElement('div'), elStyle = el.style, docBody = document.getElementsByTagName('body')[0], linkStyle = 'color:#06F;text-decoration: underline;';
		...
		// elStyle.background = '#F00 url(styles/images/not-support-ie67.png)
		// 48px 48px no-repeat';
